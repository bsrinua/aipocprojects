...
as either "dam" or "spam". The goal of the exercise is to build a
 model to identify messages as either dam or spam.
...
*****************************************************************************/
package com.asoft.spark.bda.train;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;
import com.asoft.spark.util.common.ExerciseUtils;
import com.asoft.spark.util.common.SparkConnection;
...
public class SparkMLNaiveBayes { 
	...
	public static void main(String[] args) {
		...
		Dataset<Row> smsDf = spSession.read()
				.csv("data/SMSSpamCollection-info.csv");
		smsDf.show(5);
		smsDf.printSchema();
